...
%         f = [f 1 1]; % signed mul
        ...
        n(1,1) = int64( (idx * jdx) ) ...
                 -f(1,49)*(2^6)-f(1,50)*(2^7)-f(1,51)*(2^8)-f(1,52)*(2^9)-f(1,53)*(2^10)-f(1,54)*(2^11)-f(1,55)*(2^12)-f(1,56)*(2^13)-f(1,57)*(2^7)-f(1,58)*(2^8)-f(1,59)*(2^9)-f(1,60)*(2^10)-f(1,61)*(2^11)-f(1,62)*(2^12)-f(1,63)*(2^13)-f(1,64)*(2^14);
        %         + (2^ (2*bit-1)); % signed mul
        % generated by c++ code
        n(2,1) = (-1)*f(1,1)*(2^0);
...
save('objectMat_l6.mat', 'objectMat');
