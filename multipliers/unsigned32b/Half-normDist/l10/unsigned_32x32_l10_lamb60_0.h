...
uint64_t unsigned_32x32_l10_lamb60_0(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[1]&part2[0])*pow(2, 2) + (part1[12]|part2[11])*pow(2, 12) + (part1[28]&part2[27])*pow(2, 29) + (part3[6]&part4[5])*pow(2, 8) + (part3[6]|part4[5])*pow(2, 9) + (part3[7]|part4[6])*pow(2, 9) + (part3[28]^part4[27])*pow(2, 30) + (part5[11]^part6[10])*pow(2, 15) + (part5[17]^part6[16])*pow(2, 22) + (part5[20]^part6[19])*pow(2, 24) + (part7[7]^part8[6])*pow(2, 13) + (part7[20]^part8[19])*pow(2, 26) + (part7[28]^part8[27])*pow(2, 34) + (part7[28]^part8[27])*pow(2, 35) + (part7[29]^part8[28])*pow(2, 36) + (part9[4]|part10[3])*pow(2, 13) + (part9[9]^part10[8])*pow(2, 18);
