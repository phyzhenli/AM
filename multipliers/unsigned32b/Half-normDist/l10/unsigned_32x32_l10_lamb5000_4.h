...
uint64_t unsigned_32x32_l10_lamb5000_4(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part5[3]&part6[2])*pow(2, 7) + (part5[31]&part6[30])*pow(2, 36) + (part7[8]|part8[7])*pow(2, 14) + (part7[30]&part8[29])*pow(2, 37);
