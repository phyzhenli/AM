...
uint64_t unsigned_32x32_l10_lamb200_1(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[1]&part2[0])*pow(2, 1) + (part1[2]^part2[1])*pow(2, 3) + (part3[12]&part4[11])*pow(2, 14);
