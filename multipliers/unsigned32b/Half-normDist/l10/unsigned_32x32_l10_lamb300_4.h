...
uint64_t unsigned_32x32_l10_lamb300_4(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[12]&part2[11])*pow(2, 12) + (part5[22]|part6[21])*pow(2, 26) + (part7[23]&part8[22])*pow(2, 29) + (part7[30]|part8[29])*pow(2, 37) + (part9[22]&part10[21])*pow(2, 31);
