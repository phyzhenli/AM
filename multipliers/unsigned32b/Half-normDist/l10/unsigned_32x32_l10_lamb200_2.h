...
uint64_t unsigned_32x32_l10_lamb200_2(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part5[4]|part6[3])*pow(2, 8) + (part5[20]&part6[19])*pow(2, 24) + (part7[25]^part8[24])*pow(2, 31) + (part7[31]|part8[30])*pow(2, 38) + (part9[6]^part10[5])*pow(2, 14);
