...
uint64_t unsigned_32x32_l10_lamb200_4(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[7]|part2[6])*pow(2, 8) + (part3[6]|part4[5])*pow(2, 8) + (part7[26]|part8[25])*pow(2, 33) + (part7[27]|part8[26])*pow(2, 33) + (part7[31]|part8[30])*pow(2, 37) + (part9[16]|part10[15])*pow(2, 25);
