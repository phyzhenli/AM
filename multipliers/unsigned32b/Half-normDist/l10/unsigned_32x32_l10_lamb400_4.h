...
uint64_t unsigned_32x32_l10_lamb400_4(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[19]&part2[18])*pow(2, 19) + (part3[31]&part4[30])*pow(2, 34) + (part9[19]^part10[18])*pow(2, 28);
