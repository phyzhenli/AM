...
uint64_t unsigned_32x32_l10_lamb60_3(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[7]^part2[6])*pow(2, 7) + (part1[13]|part2[12])*pow(2, 14) + (part1[27]&part2[26])*pow(2, 28) + (part1[29]^part2[28])*pow(2, 29) + (part3[5]^part4[4])*pow(2, 7) + (part3[22]^part4[21])*pow(2, 25) + (part3[31]&part4[30])*pow(2, 33) + (part7[6]^part8[5])*pow(2, 12) + (part7[6]^part8[5])*pow(2, 13) + (part7[8]&part8[7])*pow(2, 14) + (part7[8]|part8[7])*pow(2, 14) + (part7[12]&part8[11])*pow(2, 18) + (part7[13]^part8[12])*pow(2, 20) + (part7[18]&part8[17])*pow(2, 25) + (part7[26]|part8[25])*pow(2, 32) + (part7[31]^part8[30])*pow(2, 37) + (part9[5]^part10[4])*pow(2, 14) + (part9[16]|part10[15])*pow(2, 25) + (part9[17]|part10[16])*pow(2, 26) + (part9[25]|part10[24])*pow(2, 33);
