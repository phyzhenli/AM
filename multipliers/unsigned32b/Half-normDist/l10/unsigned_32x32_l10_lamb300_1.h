...
uint64_t unsigned_32x32_l10_lamb300_1(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[11]|part2[10])*pow(2, 12) + (part5[18]|part6[17])*pow(2, 22) + (part7[3]&part8[2])*pow(2, 9);
