...
uint64_t unsigned_32x32_l10_lamb3000_3(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part7[1]&part8[0])*pow(2, 7) + (part7[30]^part8[29])*pow(2, 36) + (part9[6]^part10[5])*pow(2, 14);
