...
uint64_t unsigned_32x32_l10_lamb60_1(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[5]|part2[4])*pow(2, 6) + (part1[9]&part2[8])*pow(2, 10) + (part1[12]&part2[11])*pow(2, 12) + (part1[12]^part2[11])*pow(2, 12) + (part1[14]&part2[13])*pow(2, 15) + (part1[26]^part2[25])*pow(2, 27) + (part3[19]&part4[18])*pow(2, 21) + (part3[22]^part4[21])*pow(2, 25) + (part5[25]^part6[24])*pow(2, 29) + (part7[1]|part8[0])*pow(2, 8) + (part7[11]&part8[10])*pow(2, 17) + (part7[13]^part8[12])*pow(2, 20) + (part7[15]|part8[14])*pow(2, 21) + (part7[20]&part8[19])*pow(2, 27) + (part7[28]&part8[27])*pow(2, 34) + (part8[31]*pow(2, 38)) + (part9[12]^part10[11])*pow(2, 20) + (part9[29]&part10[28])*pow(2, 37);
