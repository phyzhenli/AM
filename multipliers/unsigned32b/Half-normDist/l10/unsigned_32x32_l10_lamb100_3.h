...
uint64_t unsigned_32x32_l10_lamb100_3(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[3]|part2[2])*pow(2, 3) + (part3[6]^part4[5])*pow(2, 9) + (part5[23]|part6[22])*pow(2, 28) + (part5[25]^part6[24])*pow(2, 30) + (part5[28]^part6[27])*pow(2, 33) + (part7[5]&part8[4])*pow(2, 11) + (part7[25]^part8[24])*pow(2, 31) + (part9[2]^part10[1])*pow(2, 10);
