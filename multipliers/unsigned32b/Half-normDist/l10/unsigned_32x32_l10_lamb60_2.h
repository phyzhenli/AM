...
uint64_t unsigned_32x32_l10_lamb60_2(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[3]^part2[2])*pow(2, 3) + (part1[8]&part2[7])*pow(2, 8) + (part1[10]^part2[9])*pow(2, 11) + (part1[11]|part2[10])*pow(2, 11) + (part1[25]&part2[24])*pow(2, 25) + (part3[2]|part4[1])*pow(2, 4) + (part3[3]^part4[2])*pow(2, 5) + (part3[6]&part4[5])*pow(2, 9) + (part3[11]^part4[10])*pow(2, 13) + (part3[30]|part4[29])*pow(2, 32) + (part5[9]^part6[8])*pow(2, 13) + (part7[5]|part8[4])*pow(2, 11) + (part7[13]&part8[12])*pow(2, 20) + (part7[17]|part8[16])*pow(2, 23) + (part7[25]|part8[24])*pow(2, 31) + (part7[27]^part8[26])*pow(2, 33) + (part9[21]|part10[20])*pow(2, 29) + (part9[26]^part10[25])*pow(2, 34);
