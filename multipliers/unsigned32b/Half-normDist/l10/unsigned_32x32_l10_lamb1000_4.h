...
uint64_t unsigned_32x32_l10_lamb1000_4(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[26]|part2[25])*pow(2, 27) + (part5[10]&part6[9])*pow(2, 14) + (part7[17]^part8[16])*pow(2, 23);
