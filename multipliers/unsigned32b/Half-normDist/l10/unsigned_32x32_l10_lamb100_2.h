...
uint64_t unsigned_32x32_l10_lamb100_2(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[29]&part2[28])*pow(2, 30) + (part3[9]|part4[8])*pow(2, 12) + (part3[25]|part4[24])*pow(2, 28) + (part3[30]^part4[29])*pow(2, 32) + (part5[10]&part6[9])*pow(2, 14) + (part9[6]^part10[5])*pow(2, 15);
