...
uint64_t unsigned_32x32_l10_lamb5000_2(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[25]^part2[24])*pow(2, 25) + (part7[4]^part8[3])*pow(2, 11) + (part7[28]|part8[27])*pow(2, 35);
