...
uint64_t unsigned_32x32_l10_lamb5000_3(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part3[14]|part4[13])*pow(2, 17) + (part5[14]&part6[13])*pow(2, 18) + (part5[18]|part6[17])*pow(2, 22);
