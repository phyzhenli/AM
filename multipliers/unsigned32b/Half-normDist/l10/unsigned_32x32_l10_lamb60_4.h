...
uint64_t unsigned_32x32_l10_lamb60_4(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[12]|part2[11])*pow(2, 13) + (part1[18]&part2[17])*pow(2, 19) + (part1[21]^part2[20])*pow(2, 22) + (part1[23]|part2[22])*pow(2, 23) + (part3[1]^part4[0])*pow(2, 3) + (part3[4]^part4[3])*pow(2, 7) + (part3[18]|part4[17])*pow(2, 21) + (part3[26]&part4[25])*pow(2, 28) + (part3[26]|part4[25])*pow(2, 28) + (part5[1]&part6[0])*pow(2, 6) + (part5[26]^part6[25])*pow(2, 30) + (part5[27]^part6[26])*pow(2, 31) + (part7[9]^part8[8])*pow(2, 15) + (part7[26]^part8[25])*pow(2, 32) + (part7[28]|part8[27])*pow(2, 35) + (part7[30]&part8[29])*pow(2, 36) + (part9[1]|part10[0])*pow(2, 10) + (part9[4]&part10[3])*pow(2, 12) + (part9[5]&part10[4])*pow(2, 13) + (part9[12]^part10[11])*pow(2, 20) + (part9[16]&part10[15])*pow(2, 25) + (part9[23]&part10[22])*pow(2, 31);
