...
uint64_t unsigned_32x32_l10_lamb10000_2(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part5[29]|part6[28])*pow(2, 34) + (part7[20]^part8[19])*pow(2, 26) + (part7[26]&part8[25])*pow(2, 32);
