...
uint64_t unsigned_32x32_l10_lamb100_4(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[3]^part2[2])*pow(2, 3) + (part1[5]&part2[4])*pow(2, 5) + (part3[30]|part4[29])*pow(2, 32) + (part7[10]^part8[9])*pow(2, 16) + (part7[22]&part8[21])*pow(2, 29) + (part7[25]|part8[24])*pow(2, 32) + (part9[8]^part10[7])*pow(2, 16) + (part9[17]|part10[16])*pow(2, 25);
