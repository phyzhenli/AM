...
uint64_t unsigned_32x32_l10_lamb100_0(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part3[6]|part4[5])*pow(2, 8) + (part3[25]&part4[24])*pow(2, 27) + (part5[9]^part6[8])*pow(2, 14) + (part5[24]&part6[23])*pow(2, 29) + (part7[24]&part8[23])*pow(2, 31);
