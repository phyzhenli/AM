...
uint64_t unsigned_32x32_l10_lamb100_1(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part3[12]&part4[11])*pow(2, 14) + (part3[12]|part4[11])*pow(2, 15) + (part5[9]^part6[8])*pow(2, 13) + (part7[26]|part8[25])*pow(2, 33) + (part7[28]^part8[27])*pow(2, 35) + (part9[3]|part10[2])*pow(2, 12);
