...
uint64_t unsigned_32x32_l10_lamb400_2(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[26]&part2[25])*pow(2, 27) + (part1[27]|part2[26])*pow(2, 27) + (part7[1]&part8[0])*pow(2, 7);
