...
uint64_t unsigned_32x32_l10_lamb3000_4(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part7[20]|part8[19])*pow(2, 27) + (part7[26]&part8[25])*pow(2, 33) + (part7[29]&part8[28])*pow(2, 36);
