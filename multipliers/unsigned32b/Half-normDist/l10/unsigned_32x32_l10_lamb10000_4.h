...
uint64_t unsigned_32x32_l10_lamb10000_4(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part3[13]|part4[12])*pow(2, 16) + (part7[29]^part8[28])*pow(2, 35) + (part9[2]&part10[1])*pow(2, 11) + (part9[4]&part10[3])*pow(2, 13);
