...
uint64_t unsigned_32x32_l10_lamb10000_3(uint64_t i, uint64_t j) {
...
uint64_t z = tmp_z + (part1[31]&part2[30])*pow(2, 32) + (part5[26]^part6[25])*pow(2, 31) + (part5[28]^part6[27])*pow(2, 33);
